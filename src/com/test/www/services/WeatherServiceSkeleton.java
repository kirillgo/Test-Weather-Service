 ...
 */
     ...
     */
    public class WeatherServiceSkeleton{
         ...
         * 
             ...
             * @throws UnknownLocationFaultException 
         ...
         */
            ...
            throws ProviderInternalErrorFaultException,UnknownLocationFaultException,ProviderNotAvailableFaultException{
                ...
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#getWeather");
        }
